// Forklift Driver — calc.js PROFILES.forklift (lines 1280-1287).
...
export const forklift: OccupationProfile = {
  id: 'forklift',
  label: 'Forklift Driver',
  group: 'Trades & Industrial',
  lead: 'Forklift Driver worksheet loaded. Your car running costs, work tolls, protective clothing and the overtime-meal engine are the headline claims. Figures flow live into your ATO Cheat Sheet.',
  categories: [
    {
      label: 'D1',
    ...
    },
    {
      label: 'D2',
      d2Variant: 'forklift',
      title: 'Travel — road tolls',
      subtitle: 'Tolls driving to & from work / airport',
    },
    {
      label: 'D3',
    ...
    { label: 'D4', subtitle: 'Forklift licence (LF/LO), tickets & training', introKey: 'award' },
    {
      label: 'D5',
      itemSets: [
        ...d5EquipmentSets(GENERAL_D5_CATS, 'forklift'),
      ],
    },
  ],
