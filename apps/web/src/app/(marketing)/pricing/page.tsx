    ...
    <main className="py-20">
      <Container width="prose">
        <SectionTitle
          as="h1"
          eyebrow="Pricing"
          title="Priced for the accountant, not the app store"
          lede="Hubdoc is free inside Xero and myDeductions is free from the ATO — so Snap Apps isn’t sold as another receipt scanner to individuals. It’s a BAS and deduction-compliance layer sold through the accountants and bookkeepers who already look after Australian sole traders and tradies."
        />
      </Container>
